...
#define MYSPI_PAD           (SRE_0_SLOW_SLEW_RATE | DSE_7_R0_7 | SPEED_0_LOW_50MHz | \
                            ODE_0_OPEN_DRAIN_DISABLED | PKE_1_PULL_KEEPER_ENABLED | \
                            PUS_3_22K_OHM_PULL_UP | HYS_0_HYSTERESIS_DISABLED)

#define MYSPI1_PAD           (SRE_0_SLOW_SLEW_RATE | DSE_0_OUTPUT_DRIVER_DISABLED | SPEED_0_LOW_50MHz | \
                            ODE_0_OPEN_DRAIN_DISABLED | PKE_1_PULL_KEEPER_ENABLED | \
                            PUS_3_22K_OHM_PULL_UP | HYS_0_HYSTERESIS_DISABLED)
